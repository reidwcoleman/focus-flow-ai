...
const StudyHub = () => {
  ...
  const saveTitle = () => {
    if (editedTitle.trim() && editedTitle !== selectedNote.title) {
      notesService.updateNote(selectedNote.id, { title: editedTitle.trim() })
      refreshNotes()
  ...
  const deleteNote = () => {
    notesService.deleteNote(selectedNote.id)
    refreshNotes()
      ...
      {selectedNote && (
        ...
        >
          ...
          >
            ...
            <div className="p-6 border-b border-neutral-200 flex-shrink-0">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                  <div className="w-10 h-10 flex-shrink-0 rounded-xl bg-accent-purple/10 flex items-center justify-center">
                  ...
                  <div className="flex-1 min-w-0">
                    {isEditingTitle ? (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 px-3 py-1.5 text-lg font-bold text-neutral-900 border-2 border-accent-purple rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-purple/20"
                          autoFocus
                        />
                        <button
                          onClick={saveTitle}
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg bg-neutral-100 text-neutral-600 hover:bg-neutral-200 transition-all active:scale-95"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center gap-2">
                        <h3 className="text-lg font-bold text-neutral-900 truncate">{selectedNote.title}</h3>
                        <button
                          onClick={startEditingTitle}
                          className="p-1.5 rounded-lg hover:bg-neutral-100 transition-all active:scale-95 flex-shrink-0"
                          title="Rename note"
                        >
                    ...
                    <p className="text-sm text-neutral-500 mt-1">{selectedNote.subject}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 flex-shrink-0">
                  <button
                    onClick={() => setShowDeleteConfirm(true)}
                    className="w-10 h-10 rounded-full hover:bg-red-50 flex items-center justify-center transition-all active:scale-95"
                    title="Delete note"
                  >
            ...
            {showDeleteConfirm && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-6 rounded-3xl animate-fadeIn">
                <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl animate-scaleIn">
                  ...
                  <h3 className="text-xl font-bold text-neutral-900 text-center mb-2">Delete Note?</h3>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={deleteNote}
                      className="flex-1 py-3 px-4 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold rounded-xl transition-all active:scale-95 shadow-soft"
                    >
                      Delete
                    </button>
                  </div>
